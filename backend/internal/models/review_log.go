...
type ReviewLog struct {
	...
	DiffContent         string         `gorm:"type:text" json:"-"`             // Raw diff for diff viewer (not in list API)
	FinalPrompt         string         `gorm:"type:text" json:"-"`             // The actual prompt sent to the LLM (not in list API)
	RawFilesContext     string         `gorm:"type:text" json:"-"`             // The raw file content fetched before context extraction
